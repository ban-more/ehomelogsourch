...
public class MyTask3 implements Runnable {
    ...
    public MyTask3(Node node, String keyword,Date date1, CountDownLatch _latch) {
        this.node = node;
    ...
    public void run() {
        ...
        try {
            ...
            Log log1 = logDao.findAllLogByDate(date1,node1, node1.getNodename1(), node1.getPath1(), keyword,conn);
            Log log2 = logDao.findAllLogByDate(date1,node1, node1.getNodename2(), node1.getPath2(), keyword,conn);
            conn.close();
